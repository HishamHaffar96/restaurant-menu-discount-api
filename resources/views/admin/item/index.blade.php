...
<item-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/items') }}'" inline-template>
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th is='sortable' :column="'image'">{{ trans('admin.item.columns.image') }}</th> --}}
                                    <th is='sortable' :column="'category_id'">{{ trans('admin.item.columns.category_id') }}</th>
